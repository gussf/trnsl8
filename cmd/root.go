...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.trnsl8.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".trnsl8" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".trnsl8")
	}
